...
def retrieve_all_payment_instruments(profileid, tokenId):

    try:
        config_obj = configuration.Configuration()
        client_config = config_obj.get_configuration()
        api_instance = InstrumentIdentifierApi(client_config)
        return_data, status, body = api_instance.get_all_payment_instruments(profileid, tokenId)
...
if __name__ == "__main__":
    ...
    retrieve_all_payment_instruments(profileid, tokenId)
