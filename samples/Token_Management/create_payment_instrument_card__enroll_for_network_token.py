...
def create_payment_instrument_card__enroll_for_network_token(profileid):
    ...
    instrumentIdentifierCardNumber = "4622943127013705"
...
if __name__ == "__main__":
    ...
    create_payment_instrument_card__enroll_for_network_token(profileid)
