...
def create_payment_instrument_bank_account(profileid):
    ...
    processingInformationBankTransferOptions = TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseEmbeddedProcessingInformationBankTransferOptions(
        se_c_code = processingInformationBankTransferOptionsSeCCode
    )
...
if __name__ == "__main__":
    ...
    create_payment_instrument_bank_account(profileid)
