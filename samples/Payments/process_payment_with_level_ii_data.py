...
def process_payment_with_level_ii_data():
    ...
    orderInformationAmountDetailsTotalAmount = "112.00"
    ...
    orderInformationInvoiceDetailsPurchaseOrderNumber = "LevelII Auth Po"
...
if __name__ == "__main__":
    process_payment_with_level_ii_data()
