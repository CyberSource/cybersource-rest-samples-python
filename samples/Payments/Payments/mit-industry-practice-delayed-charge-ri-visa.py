...
def mit_industry_practice_delayed_charge_ri_visa():
    ...
    processingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransactionReason = "2"
    ...
    consumerAuthenticationInformationParesStatus = "Y"
    consumerAuthenticationInformation = Ptsv2paymentsConsumerAuthenticationInformation(
        ...
        pares_status = consumerAuthenticationInformationParesStatus
    )
...
if __name__ == "__main__":
    mit_industry_practice_delayed_charge_ri_visa()