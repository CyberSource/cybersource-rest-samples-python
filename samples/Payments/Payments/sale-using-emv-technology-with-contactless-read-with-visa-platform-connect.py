...
def sale_using_emv_technology_with_contactless_read_with_visa_platform_connect():
...
if __name__ == "__main__":
    sale_using_emv_technology_with_contactless_read_with_visa_platform_connect()
