...
def sale_using_emv_technology_with_contact_read_two_for_card_present_enabled_acquirer():
...
if __name__ == "__main__":
    sale_using_emv_technology_with_contact_read_two_for_card_present_enabled_acquirer()
