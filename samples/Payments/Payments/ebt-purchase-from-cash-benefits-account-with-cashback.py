...
def ebt_purchase_from_cash_benefits_account_with_cashback():
    clientReferenceInformationCode = "EBT - Purchase from Cash Benefits Account with CB"
    ...
    processingInformationElectronicBenefitsTransferCategory = "CASH"
    ...
    orderInformationAmountDetailsTotalAmount = "702.00"
    orderInformationAmountDetailsCurrency = "USD"
    orderInformationAmountDetailsCashbackAmount = "45.00"
    orderInformationAmountDetails = Ptsv2paymentsOrderInformationAmountDetails(
        total_amount = orderInformationAmountDetailsTotalAmount,
        currency = orderInformationAmountDetailsCurrency,
        cashback_amount = orderInformationAmountDetailsCashbackAmount
    )
...
if __name__ == "__main__":
    ebt_purchase_from_cash_benefits_account_with_cashback()