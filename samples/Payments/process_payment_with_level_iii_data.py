...
def process_payment_with_level_iii_data():
    clientReferenceInformationCode = "TC50171_14"
    ...
    orderInformationLineItems1 = Ptsv2paymentsOrderInformationLineItems(
    ...
    orderInformationInvoiceDetailsPurchaseOrderNumber = "LevelIII Auth Po"
    orderInformationInvoiceDetails = Ptsv2paymentsOrderInformationInvoiceDetails(
        purchase_order_number = orderInformationInvoiceDetailsPurchaseOrderNumber
    )
...
if __name__ == "__main__":
    process_payment_with_level_iii_data()
