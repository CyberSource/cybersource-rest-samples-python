...
import process_credit_with_servicefee
import json
import os
...
def void_credit_with_servicefee():
    try:
        # Getting the credit_id dynamically using process_a_credit method
        api_credit_response = process_credit_with_servicefee.process_credit_with_servicefee()
