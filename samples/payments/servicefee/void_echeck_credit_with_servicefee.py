...
import process_echeck_credit_with_servicefee
import json
import os
...
def void_echeck_credit_with_servicefee():
    try:
        # Getting the credit_id dynamically using process_a_credit method
        api_credit_response = process_echeck_credit_with_servicefee.process_echeck_credit_with_servicefee("false")
...
if __name__ == "__main__":
    void_echeck_credit_with_servicefee()
