...
def partial_authorization():
    try:
        ...
        emv_data = V2paymentsPointOfSaleInformationEmv()
        point_of_sale_info.cat_level = 6
        point_of_sale_info.card_present = "true"
        emv_data.fallback_condition="swiped"
        emv_data.fallback="N"
        point_of_sale_info.terminal_capability=4
        point_of_sale_info.emv=emv_data.__dict__
