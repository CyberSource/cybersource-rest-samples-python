...
def recurring_indicator():
    try:
        ...
        client_reference._code = "TC50171_7"
        request.client_reference_information = client_reference.__dict__
    
        processing_info = V2paymentsProcessingInformation()
        processing_info.commerce_indicator = "recurring"
        ...
        amount_details.total_amount = "106.00"
        ...
        card_information.number = "6334580500000000"
