...
def merchant_description():
    try:
        ...
        amount_details.total_amount = "72210"
        ...
        merchant_info = V2paymentsMerchantInformation()
        merchant_descriptor = V2paymentsMerchantInformationMerchantDescriptor()
        merchant_descriptor.name = "TestDescriptionInformation"
        merchant_descriptor.contact = "123-456-7890"
        merchant_info.merchant_descriptor = merchant_descriptor.__dict__
