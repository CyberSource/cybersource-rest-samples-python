...
#This is a sample code to process check payments with service fee 

def process_echeck_payment_with_servicefee(flag):
    try:
...
if __name__ == "__main__":
    process_echeck_payment_with_servicefee(False)
