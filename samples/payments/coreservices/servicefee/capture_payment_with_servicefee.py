...
#This is the sample code to capture payment with service fee
#Sample code intially makes a transaction and tries to capture it
def capture_payment_with_servicefee():
    try:
        ...
        #Set order information details and set ampunt which needs to be captured
        ...
        #set merchant information details
