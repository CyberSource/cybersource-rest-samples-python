...
#Following is the sample code to make echeck credit. 
#At First transaction is made and transaction gets processed and Refund is done via credit
def process_echeck_credit(flag):
    try:
        # Setting the json message body
        request = CreatePaymentRequest()


        # This is the section to set Client reference information details
