...
authorization_path = os.path.join(os.getcwd(), "samples", "payments", "coreservices", "authorization-using-swiped-track-data.py")
authorization_using_swiped_track_data = SourceFileLoader("module.name", authorization_path).load_module()
...
def capture_of_authorization_that_used_swiped_track_data():
    authResponse = authorization_using_swiped_track_data.authorization_using_swiped_track_data()
    id = authResponse.id
