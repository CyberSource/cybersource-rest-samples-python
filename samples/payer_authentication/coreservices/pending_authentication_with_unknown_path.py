...
def pending_authentication_with_unknown_path():
    try:
        ...
        client_reference = Riskv1authenticationsClientReferenceInformation("UNKNOWN")
        ...
        card = Riskv1authenticationsPaymentInformationCard("001","12","2025","4012001037490014")
        ...
        print("Exception when calling PayerAuthenticationApi->pending_authentication_with_unknown_path: %s\n" % e)


if __name__ == "__main__":
    pending_authentication_with_unknown_path()
