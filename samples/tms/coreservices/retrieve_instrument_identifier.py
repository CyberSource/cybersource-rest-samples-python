...
def retrieve_instrument_identifier():
    try:
        ...
        return_data, status, body =instrument_identifier.tms_v1_instrumentidentifiers_token_id_get("93B32398-AD51-4CC2-A682-EA3E93614EB1",api_instrument_identifier_response.id)
        print(status)
        print(body)
        return return_data
