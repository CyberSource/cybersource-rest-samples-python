...
def retrieve_all_payments():
    try:
        ...
        instrument_identifier.instrumentidentifiers_token_id_paymentinstruments_get("93B32398-AD51-4CC2-A682-EA3E93614EB1",api_instrument_identifier_response.id)
