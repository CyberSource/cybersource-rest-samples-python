...
def create_invoice_and_assign_it_specific_invoice_number():
    ...
    invoiceInformationInvoiceNumber = "A123"
    ...
    invoiceInformation = Invoicingv2invoicesInvoiceInformation(
        invoice_number = invoiceInformationInvoiceNumber,
...
if __name__ == "__main__":
    create_invoice_and_assign_it_specific_invoice_number()
