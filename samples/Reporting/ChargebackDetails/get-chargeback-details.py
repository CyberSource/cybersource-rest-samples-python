...
def get_chargeback_details():
    ...
    try:
        ...
        api_instance = ChargebackDetailsApi(client_config)
        return_data, status, body = api_instance.get_chargeback_details(start_time, end_time, organization_id = organization_id)
