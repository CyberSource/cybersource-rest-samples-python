...
def bin_lookup_with_tms_customer_id():
    paymentInformationCustomerId = "E5426CFDE77F7390E053A2598D0A925D"
    paymentInformationCustomer = GetAllSubscriptionsResponsePaymentInformationCustomer(
...
if __name__ == "__main__":
    bin_lookup_with_tms_customer_id()