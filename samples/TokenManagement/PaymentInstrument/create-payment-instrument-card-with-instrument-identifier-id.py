...
def create_payment_instrument_card_with_instrument_identifier_id():
    ...
    instrumentIdentifierId = "7020000000001061135"
...
if __name__ == "__main__":
    create_payment_instrument_card_with_instrument_identifier_id()
