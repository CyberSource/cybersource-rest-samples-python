...
def create_payment_instrument_bank_account():
    ...
    bankAccount = DefaultPaymentInstrumentBankAccount(
    ...
    buyerInformationPersonalIdentificationIssuedBy1 = DefaultPaymentInstrumentBuyerInformationIssuedBy(
        administrative_area = "CA"
    )

    buyerInformationPersonalIdentification1 = DefaultPaymentInstrumentBuyerInformationPersonalIdentification(
        id = "57684432111321",
        type = "driver license",
    ...
    buyerInformation = DefaultPaymentInstrumentBuyerInformation(
    ...
    billTo = DefaultPaymentInstrumentBillTo(
    ...
    instrumentIdentifier = DefaultPaymentInstrumentInstrumentIdentifier(
