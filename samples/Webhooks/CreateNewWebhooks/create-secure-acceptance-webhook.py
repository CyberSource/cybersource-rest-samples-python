...
def create_secure_acceptance_webhook():
    ...
    eventTypes = []
    eventTypes.append("sa.orders.rawtransactionresults")
    eventTypes.append("sa.orders.cardholderreceipts")
    eventTypes.append("sa.orders.merchantreceipts")
...
if __name__ == "__main__":
    create_secure_acceptance_webhook()