...
def create_recurring_billing_webhook():
    ...
    eventTypes = []
    eventTypes.append("rbs.subscriptions.charge.pre-notified")
    eventTypes.append("rbs.subscriptions.charge.created")
    eventTypes.append("rbs.subscriptions.charge.failed")
...
if __name__ == "__main__":
    create_recurring_billing_webhook()