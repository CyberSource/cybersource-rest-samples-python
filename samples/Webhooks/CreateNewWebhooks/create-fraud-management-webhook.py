...
def create_fraud_management_webhook():
    ...
    eventTypes = []
    eventTypes.append("risk.profile.decision.review")
    eventTypes.append("risk.profile.decision.reject")
    eventTypes.append("risk.profile.decision.monitor")
    eventTypes.append("risk.casemanagement.addnote")
    eventTypes.append("risk.casemanagement.decision.accept")
    eventTypes.append("risk.casemanagement.decision.reject")
...
if __name__ == "__main__":
    create_fraud_management_webhook()