...
def create_invoicing_webhook():
    ...
    eventTypes = []
    eventTypes.append("invoicing.customer.invoice.cancel")
    eventTypes.append("invoicing.customer.invoice.overdue-reminder")
    eventTypes.append("invoicing.customer.invoice.paid")
    eventTypes.append("invoicing.customer.invoice.partial-payment")
    eventTypes.append("invoicing.customer.invoice.partial-resend")
    eventTypes.append("invoicing.customer.invoice.reminder")
    eventTypes.append("invoicing.customer.invoice.send")
    ...
    try:
        ...
        return_data, status, body = api_instance.create_webhook(requestObj)
        ...
        print("\nException when calling CreateNewWebhooksApi->create_webhook: %s\n" % e)

def write_log_audit(status):
    print(f"[Sample Code Testing] [{Path(__file__).stem}] {status}")

if __name__ == "__main__":
    create_invoicing_webhook()