...
def create_token_management_webhook():
    ...
    eventTypes = []
    eventTypes.append("tms.networktoken.provisioned")
    eventTypes.append("tms.networktoken.updated")
    eventTypes.append("tms.token.pan_updated")
    eventTypes.append("tms.token.created")
    eventTypes.append("tms.token.updated")
...
if __name__ == "__main__":
    create_token_management_webhook()